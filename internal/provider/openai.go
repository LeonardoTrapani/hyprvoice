...
func (p *OpenAIProvider) Models() []Model {
	...
	return []Model{
		...
		// GPT-5 family. These models reject sampling params (temperature, top_p,
		// n, presence_penalty, frequency_penalty), so RestrictedSampling is set
		// and the OpenAI adapter omits those fields from the request.
		{
			ID:                 "gpt-5",
			Name:               "GPT-5",
			Description:        "Largest GPT-5; highest quality cleanup",
			Type:               LLM,
			SupportsBatch:      true,
			SupportsStreaming:  false,
			Local:              false,
		...
		},
		{
			ID:                 "gpt-5-mini",
			Name:               "GPT-5 Mini",
			Description:        "Smaller, cheaper GPT-5",
			Type:               LLM,
			SupportsBatch:      true,
			SupportsStreaming:  false,
			Local:              false,
		...
		},
		{
			ID:                 "gpt-5.4",
			Name:               "GPT-5.4",
			Description:        "Updated GPT-5 line; better at long-form rewrites",
			Type:               LLM,
			SupportsBatch:      true,
			SupportsStreaming:  false,
			Local:              false,
		...
		},
		{
			ID:                 "gpt-5.4-mini",
			Name:               "GPT-5.4 Mini",
			Description:        "Fast and cheap GPT-5.4; balanced default for cleanup",
			Type:               LLM,
			SupportsBatch:      true,
			SupportsStreaming:  false,
			Local:              false,
		...
		},
		{
			ID:                 "gpt-5.4-nano",
			Name:               "GPT-5.4 Nano",
			Description:        "Cheapest GPT-5.4; lowest latency",
			Type:               LLM,
			SupportsBatch:      true,
			SupportsStreaming:  false,
			Local:              false,
